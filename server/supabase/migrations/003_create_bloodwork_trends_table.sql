...
-- This table stores calculated trends for bloodwork markers over time
...
CREATE INDEX IF NOT EXISTS idx_bloodwork_trends_user_id ON bloodwork_trends(user_id);
CREATE INDEX IF NOT EXISTS idx_bloodwork_trends_marker_name ON bloodwork_trends(marker_name);
CREATE INDEX IF NOT EXISTS idx_bloodwork_trends_calculated_at ON bloodwork_trends(calculated_at DESC);
CREATE INDEX IF NOT EXISTS idx_bloodwork_trends_user_marker ON bloodwork_trends(user_id, marker_name);
